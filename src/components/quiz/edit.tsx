...
import { Trash2, Check, Save, Plus } from "lucide-react";
import { EditQuizComponentProps } from "@/types/edit-quiz-component-props";

export function EditQuizComponent({ title, description, questions, saving, setTitle, setDescription, removeQuestion, updateQuestion, updateOption, setCorrectOption, addQuestion, handleSave } : EditQuizComponentProps) {
